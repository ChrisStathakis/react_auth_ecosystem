...
export const VENDORS_LIST_ENDPOINT = BASE_URL + 'vendors/vendors/';
...
export const INVOICE_LIST_ENDPOINT = BASE_URL + 'vendors/invoices/';
export const PAYMENT_METHOD_ENDPOINT = BASE_URL + 'vendors/payment-methods/';
export const PAYMENT_ENDPOINT = 'PAYMENT_ENDPOINT';